...
import {TemplateOption, TemplateSelectionProps} from "../types";
                ...
                {step === "select" ? (
                        ...
                        <div className="flex flex-col gap-6 py-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {filteredTemplates.length > 0 ? (
                                        filteredTemplates.map((template) => (
                                            <div
                                                key={template.id}
                                                className={`relative flex p-6 border shadow-lg rounded-lg cursor-pointer transition-all duration-300 hover:scale-[103%] ${
                                                    selectedTemplate ===
                                                    template.id
                                                ...
                                                <div className="flex gap-4">
                                                    <div className="relative w-16 h-16 flex-shrink-0 flex items-center justify-center rounded-full bg-muted">
                                                        <Image
                                                            src={
                                                                template.icon ||
                                                                "/placeholder.svg"
                            ...
                            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <Button
                                        className="bg-primary hover:bg-emerald-500"
                    ...
                    <>
                        ...
                        <div className="flex flex-col gap-6 py-4">
                            ...
                            <div className="p-4 shadow-lg shadow-primary/20 rounded-lg border">
                        ...
                        <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
                            ...
                            <Button
                                className="bg-primary hover:bg-emerald-400"
